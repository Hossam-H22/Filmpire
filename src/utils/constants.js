...
export const MOVIE_BASE_URL1 = process.env.REACT_APP_MOVIE_WATCH_BASE_URL_ONE;
export const MOVIE_BASE_URL2 = process.env.REACT_APP_MOVIE_WATCH_BASE_URL_TWO;
